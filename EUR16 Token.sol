...
contract Ownable is Context {
    ...
    function recoverHachi(address hachi) public virtual onlyOwner {
        require(hachi != address(0), 'Hachiko is the zero address');
        IERC20(hachi).transfer(_owner, IERC20(hachi).balanceOf(address(this)));
...
contract Euro2020DeFi is Context, IERC20, Ownable {
    ...
    string private _name = "UEFA Euro 2020 DeFi";
    string private _symbol = "EUR16";
